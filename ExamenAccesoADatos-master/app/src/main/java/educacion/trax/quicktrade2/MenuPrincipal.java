...
public class MenuPrincipal extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button seguirUsu=findViewById(R.id.btnSeguir);
        seguirUsu.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (v.getId()==R.id.btnSeguir){
            Intent i =new Intent(getApplicationContext(),anyadirSeguidor.class);
            startActivity(i);
        }
    }
